...
legend("bottomleft",legend=Players,inset=0.01,pch=15:18,col=c(1:4,6),horiz=F)
...
Games[1,]# this is noy matrix ,it is just vector
Games[1,5]#also this is
is.matrix(Games[1,])
is.vector(Games[1,])

#you can fix it with drop function
Games[1,,drop=F]
Games[1,5,drop=F]# Both of them matrix
...
# Let's manipulate visulization

Data<-MinutesPlayed[1:3,]

matplot(t(Data), type='b',pch=15:18,col=c(1:4,6))
legend("bottomleft",legend=Players[1:3],inset=0.01,pch=15:18,col=c(1:4,6),horiz=F)
...
# also you can give defolt value to rows
newplot<-function(data,rows=1:10){
  Data<-data[rows,,drop=F]
  
  matplot(t(Data), type='b',pch=15:18,col=c(1:4,6))
  legend("bottomleft",legend=Players[1:10],inset=0.01,pch=15:18,col=c(1:4,6),horiz=F)
}
